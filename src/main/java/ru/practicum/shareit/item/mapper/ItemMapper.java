...
public abstract class ItemMapper {
    ...
    @Mapping(target = "lastBooking", expression = "java(dateTimeMapper.map(bookingRepository.getLastBookingByItemId(item.getId())))")
    @Mapping(target = "nextBooking", expression = "java(dateTimeMapper.map(bookingRepository.getNextBookingByItemId(item.getId())))")
